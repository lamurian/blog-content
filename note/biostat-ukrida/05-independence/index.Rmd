...
```{r prop.1, echo=FALSE}
binom.test(6, 10, 0.5) %>% broom::tidy() %>% kable(format="simple", caption="Binomial test")
prop.test(6, 10, 0.5) %>% broom::tidy() %>% kable(format="simple", caption="Proportion test")
```
...
```{r prop.2, echo=FALSE}
binom.test(60, 100, 0.5) %>% broom::tidy() %>% kable(format="simple", caption="Binomial test")
prop.test(60, 100, 0.5) %>% broom::tidy() %>% kable(format="simple", caption="Proportion test")
```
